...
public enum Services {
    public enum Shared {
        ...
        public final class Good: ContractEntity {
            public static let keyDictionary: [String: String] = [
                "ID": "a",
                "name": "c",
                "description": "d",
            ...
            public static func initWithValidation(from dictionary: Entita.Dict, context: LGNCore.Context) -> Future<Good> {
