/**
 * This file has been autogenerated by LGNC assembler on 2020-09-20 18:23:29 +0000 (1600626209.12204).
    ...
    enum Login: Contract {
        ...
        public final class Response: ContractEntity {
            ...
            public static func initWithValidation(
                ...
                let token: LGNC.Entity.Cookie?
                do {
                    token = try self.extractCookie(param: "token", from: dictionary, context: context) // header set-cookie
                } catch {
                    return eventLoop.makeFailedFuture(error)
                }
